...
const Header = () => {
  return (
    <div className="min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden" style={{backgroundImage: "url('/header_img.png')"}} id='Header'>
        ...
        viewport={{once: true}}
        className="container text-center mx-auto py-4 px-6 md:px-20 lg:px-32px text-white">
            <h2 className="text-5xl sm:text-6xl md;text-[82px] inline-block max-w-3xl font-semibold pt-20">Expolre homes that fit your dreams</h2>
